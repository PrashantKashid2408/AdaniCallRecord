...
{
    public class RolesBusinessFacade//:UniversalObject
    {
        dynamic objdynamicWrapper; 
		RolesWrapperColletion objRolesWrapperColletion = new RolesWrapperColletion();
        RolesWrapper objRolesWrapper = new RolesWrapper();
		private static readonly string _module = "AdaniCall.Business.BusinessFacade.RolesBusinessFacade";
		public RolesBusinessFacade()
        {
            
        }
        public RolesBusinessFacade(dynamic WrapperType)
        {
