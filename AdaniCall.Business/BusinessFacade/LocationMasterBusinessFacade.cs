...
{
    public class LocationMasterBusinessFacade//:UniversalObject
    {
        dynamic objdynamicWrapper; 
		LocationMasterWrapperColletion objLocationMasterWrapperColletion = new LocationMasterWrapperColletion();
        LocationMasterWrapper objLocationMasterWrapper = new LocationMasterWrapper();
		private static readonly string _module = "AdaniCall.Business.BusinessFacade.LocationMasterBusinessFacade";
		public LocationMasterBusinessFacade()
        {
            
        }
        public LocationMasterBusinessFacade(dynamic WrapperType)
        {
        ...
        public dynamic GetRecordsListByValue(string Field, String Values)
        {
            ...
            if (objLocationMasterWrapperColletion.GetRecords(false, Sort, true, Field, Values))
            {
                return objdynamicWrapper.Items;
            }
            return null;
