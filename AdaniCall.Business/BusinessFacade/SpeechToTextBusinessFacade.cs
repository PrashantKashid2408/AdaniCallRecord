...
{
    public class SpeechToTextBusinessFacade//:UniversalObject
    {
        dynamic objdynamicWrapper; 
		SpeechToTextWrapperColletion objSpeechToTextWrapperColletion = new SpeechToTextWrapperColletion();
        SpeechToTextWrapper objSpeechToTextWrapper = new SpeechToTextWrapper();
		private static readonly string _module = "AdaniCall.Business.BusinessFacade.SpeechToTextBusinessFacade";
		public SpeechToTextBusinessFacade()
        {
            
        }
        public SpeechToTextBusinessFacade(dynamic WrapperType)
        {
        ...
        public bool Save(dynamic objEntity)
        {
            try
            {
                objSpeechToTextWrapper.objWrapperClass = objEntity;
                ...
                bool result = objSpeechToTextWrapper.Save(ref CommandsObj, ref commandCounter);
        ...
        public List<SpeechToText> GetPendingTextAnalysis()
        {
            try
            {
                return objSpeechToTextWrapperColletion.GetPendingTextAnalysis();
            }
            catch (Exception ex)
            {
                Log.WriteLog(_module, "GetPendingTextAnalysis()", ex.Source, ex.Message, ex);
            }
            return new List<SpeechToText>();
        }
    }
}
