var strDomain = "https://agcx.azurewebsites.net";
var callID = "";
...
subscribeToRemoteVideoStream = async (remoteVideoStream) => {
    ...
    let view;
    let remoteVideoContainer0 = document.createElement('div');
    remoteVideoContainer0.className = 'remote-video-container';

    const createView = async () => {
        // Create a renderer view for the remote video stream.
        view = await renderer.createView();
        // Attach the renderer view to the UI.
        remoteVideoContainer0.appendChild(view.target);
        remoteVideoContainer.appendChild(remoteVideoContainer0);
    }
    remoteVideoStream.on('isAvailableChanged', async () => {
        try {
            if (remoteVideoStream.isAvailable) {
                ...
                view.dispose();
                remoteVideoContainer.removeChild(remoteVideoContainer0);
            }
        } catch (e) {
            console.error(e);
        }
