...
//        public RecordingsController(IConfiguration configuration, ILogger<CallRecordingController> logger)
//        {

//            blobStorageConnectionString = configuration.GetConnectionString("BlobStorageConnectionString");
//            containerName = configuration.GetConnectionString("BlobContainerName");
//            callAutomationClient = new CallAutomationClient(configuration.GetConnectionString("ACSResourceConnectionString"));
//            Logger = logger;
//        }
//        [HttpGet]
